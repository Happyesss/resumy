...
CREATE TABLE IF NOT EXISTS public.resumes (
  ...
  template text NULL DEFAULT 'default' CHECK (template IN ('default', 'classic', 'classic-1', 'modern', 'modern-1', 'modern-2', 'creative', 'creative-1', 'creative-2', 'minimal', 'minimal-1')),
