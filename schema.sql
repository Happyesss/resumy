...
CREATE TABLE IF NOT EXISTS public.resumes (
  ...
  template text NULL DEFAULT 'default' CHECK (template IN ('default', 'classic', 'classic-1', 'modern', 'modern-1', 'modern-2', 'creative', 'creative-modern', 'creative-minimal', 'minimal', 'minimal-1')),
