...
export function ApiKeysForm() {
  ...
  useEffect(() => {
    ...
    if (storedModel) {
      ...
      // Set the best default model for all users
      ...
      <div className="p-5 rounded-xl bg-gradient-to-br from-white/50 to-white/30 border border-white/40 shadow-xl backdrop-blur-sm">
        ...
        <div className="mt-2 mb-4 space-y-2">
          ...
          <div className="p-3 rounded-lg bg-amber-50/50 border border-amber-200/50 text-amber-900 text-sm">
            <p><strong>Security Note:</strong> API keys are stored locally in your browser and are used to access AI models directly.</p>
            <p className="mt-1">Your API keys remain private and are only sent to the respective AI providers to process your requests.</p>
          </div>
        </div>
